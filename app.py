...
with tab_manual:
    ...
    with st.expander("✅ ขั้นตอนการใช้งานอุปกรณ์ และ Protocol", expanded=True):
        st.markdown("""
        1. **การติดตั้ง:** ติดเซนเซอร์ที่เอวด้านหลัง (L3-L5) เพื่อให้อยู่ใกล้ Center of Mass [Ref: รายละเอียด.pdf p.2]
        2. **การบันทึก:** ตั้งค่า Sampling Rate ที่ 50-100 Hz [Ref: รายละเอียด.pdf p.2]
        3. **Walking Protocol:** เดินทางตรงปกติ 10-20 วินาที [Ref: รายละเอียด.pdf p.1]
        4. **STS Protocol:** ลุก-นั่งจากเก้าอี้ 5 ครั้งต่อเนื่อง [Ref: Prototype Fallsense.pdf p.9]
        """)
